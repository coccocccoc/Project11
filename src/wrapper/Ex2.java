...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		// Integer = int (int -> Integer) (오토박싱)
		// 자동으로 바뀜. 자바의 기본 설계
		Integer iNum2 = 100; // new Integer(100) 과 같음
		
		// intValue: Integer 안에 있는 값을 꺼내는 함수
		...
		// boolean = Boolean
		boolean b2 = bool2; // bool1.booleanValue() 와 같다
		
		// Character
		Character char1 = new Character('a');
		Character char2 = 'a'; // 바로 값을 대입
		
		char c1 = char1.charValue(); // 값 꺼내기
